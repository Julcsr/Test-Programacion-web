...
@Component
public class PageInitPaginationCustomer {
	...
	public  ModelAndView initPagination(Optional<Integer> pageSize, Optional<Integer> page, String url) {
		...
		Page<Customer> customersList = customerService.findAll(PageRequest.of(evalPage, evalPageSize));
		PagerModel pager = new PagerModel(customersList.getTotalPages(), customersList.getNumber(), BUTTONS_TO_SHOW);

		initModelView.addObject("customersList", customersList);
